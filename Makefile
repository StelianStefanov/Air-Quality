...
tailwind: # Tailwindcss rebuild (watch) tops="--minify"
	@./bin/tailwindcss -i src/web/static/css/builder/tailwindcss-in.css -o src/web/static/css/tailwindcss.css --watch --minify $(tops)
...
web-start: # starts web server
	@fastapi run www.py --host 0.0.0.0 --port 8000 --reload
